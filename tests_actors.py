...
def test_edit_actor(test_obj):
    # the batch file should have set up a move with id 2 and name 'actor for editing'
...
def test_delete_actor(test_obj):
    # the batch file should have set up a move with id 3 and name 'actor for deleting 1'
